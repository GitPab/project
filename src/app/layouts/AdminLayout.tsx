...
export default function AdminLayout({ children }: AdminLayoutProps) {
  ...
  const menuItems = [
    ...
    { label: 'Quản lý trường', href: '/admin/universities', icon: '🏫' },
    { label: 'Sinh viên', href: '/admin/students', icon: '👨‍🎓' },
    { label: 'Thanh toán', href: '/admin/payments', icon: '💳' },
    { label: 'Lịch hẹn', href: '/admin/appointments', icon: '📅' },
    { label: 'Tin nhắn', href: '/admin/messages', icon: '💬' },
    { label: 'Tài liệu', href: '/admin/documents', icon: '📄' },
