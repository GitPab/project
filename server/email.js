...
// Email templates
const templates = {
  adminInvite: (setupUrl, inviterName) => ({
...
export async function sendEmail(to, template, options = {}) {
  ...
  try {
    ...
    logger.error('Failed to send email', { to, subject: template.subject, error: error.message });
    return { success: false, error: error.message };
  }
}

// Send admin invite email
export async function sendAdminInviteEmail(to, setupUrl, inviterName) {
